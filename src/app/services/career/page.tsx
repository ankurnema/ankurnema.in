...
export const metadata: Metadata = {
  ...
  description:
    'Career guidance by Ankur Nema — strategic advice for engineers navigating growth and transitions in tech.',
}
...
const offerings = [
  {
    ...
    description:
      'A focused 60-minute 1:1 to map your current situation, clarify your goals, and walk away with a concrete next-step plan. Ideal for engineers who need a clear direction without a long commitment.',
  },
  {
    icon: Map,
    name: 'Career Audit Package',
    description:
      'Three 60-minute sessions spread over a few weeks, plus a written career roadmap delivered at the end. Covers your current role, growth gaps, skill positioning, and a prioritised action plan for the next 6–12 months.',
  },
]
      ...
      <section className="bg-brand-navy dark:bg-brand-surface-dark px-6 py-16 sm:py-24 relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <p className="text-white/80 text-base sm:text-lg font-sans max-w-2xl leading-relaxed">
            Strategic 1:1 guidance for engineers at inflection points — whether you&apos;re eyeing a
            promotion, switching roles, moving into a new domain, or simply unsure what your next
      ...
      <section className="bg-brand-canvas dark:bg-brand-canvas-dark px-6 py-16 sm:py-20">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {offerings.map(({ icon: Icon, name, description }, i) => (
              <FadeInSection key={name} delay={i * 0.1}>
                <div className="bg-brand-surface dark:bg-brand-surface-dark border border-brand-slate/10 dark:border-brand-slate-dark/10 rounded-xl p-6 h-full flex flex-col">
        ...
        <div className="max-w-5xl mx-auto">
          <FadeInSection>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-3xl sm:text-4xl font-semibold font-heading text-brand-navy dark:text-brand-charcoal-dark">
                Who this is for
              </h2>
            </div>
            <p className="text-brand-slate dark:text-brand-slate-dark text-base font-sans leading-relaxed mb-8 max-w-2xl">
              Engineers with 2–10 years of experience who are at a crossroads in their career.
            </p>
            <div className="flex flex-wrap gap-3">
              {personas.map((p) => (
                <span
                  key={p}
                  className="inline-block bg-brand-canvas dark:bg-brand-canvas-dark border border-brand-slate/10 dark:border-brand-slate-dark/10 text-brand-navy dark:text-brand-charcoal-dark text-sm font-sans font-medium px-4 py-2 rounded-full"
                >
                  {p}
                </span>
              ))}
