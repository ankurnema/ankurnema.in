...
| 005b | [005b-ga4-integration.md](005b-ga4-integration.md) | **Run after creating GA4 property** — Install `@next/third-parties`, wire `<GoogleAnalytics>` into `layout.tsx` | ⏳ Pending |
